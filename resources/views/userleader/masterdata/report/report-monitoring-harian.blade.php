...
<body style="padding-top: 25px; padding-left: 0px;">
    ...
    <div class="header">
        <div class="absolute-kiri">
            <img style="padding-top: 0px; margin: 2px; left: 2px; padding-left: 15%;" src="data:image/png;base64, {{$image}}" width="100">
        ...
        <div class="absolute">
            <img style="padding-top: 2px; padding-left: 2px; left: 10px;" src="data:image/png;base64, {!! base64_encode(
                QrCode::eyeColor(0, 0, 111, 115, 255, 114, 232)->style('round')->eye('circle')->format('svg')->size(97)->errorCorrection('H')->generate('qwe'),
            ) !!}">
        </div>
    </div>
    @php

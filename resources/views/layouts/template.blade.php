...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Log IT | Management System</title>
...
<body>
                    ...
                    <div class="toggle-icon-wrapper">
                        ...
                        <div class="d-flex align-items-center py-3">
                            <img class="me-1" src="{{ asset('img/pram.png') }}" alt=""
                                width="65" /><span class="font-sans-serif fs-2 text-danger">Log IT</span>
                        </div>
                    </a>
                </div>
                        ...
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            <li class="nav-item">
                                ...
                                <ul class="nav collapse false" id="dashboard">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('dashboard_home') }}" aria-expanded="false">
                            ...
                            ->where('z_menu_user.access_code', Auth::user()->kd_akses)->get()
                            ->unique('menu_code');
                            @endphp
                            ...
                            <li class="nav-items">
                                ...
                                ->where('z_menu_user.access_code', Auth::user()->kd_akses)
                ...
                <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
                    ...
                    <a class="navbar-brand me-1 me-sm-3" href="#">
                        <div class="d-flex align-items-center"><img class="me-2"
                                ...
                                width="80" /><span class="font-sans-serif text-danger">Log IT</span>
                        </div>
                    </a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link notification-indicator notification-indicator-danger px-0 fa-icon-wait"
                                ...
                                <span class="fas fa-bell" data-fa-transform="shrink-6"
                                    style="font-size: 33px;"></span><span id="detikwaktu"><strong id="kayu"></strong></span>
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                                <div class="bg-white dark__bg-1000 rounded-2 py-2">
                                    ...
                                    <a class="dropdown-item text-danger" href="{{ route('logout') }}"><span
                                            class="fab fa-keycdn me-2"></span> Logout</a>
                                </div>
                            </div>
                        </li>
                    </ul>
    ...
    <script>
        ...
        $(document).on("click", "#navbarDropdownNotification", function(e) {
            ...
            $.ajax({
                url: "{{ route('dashboard_get_message') }}",
                type: "POST",
                cache: false,
                data: {
                    "_token": "{{ csrf_token() }}",
        ...
        // data
        $(document).on("click", "#button-proses-data-pesan", function(e) {
            e.preventDefault();
            ...
            $.ajax({
                url: "{{ route('dashboard_get_message_proses') }}",
                type: "POST",
                cache: false,
                data: {
                    "_token": "{{ csrf_token() }}",

...
<div class="card mb-3">
    <div class="card-body border-top">
        <div class="d-flex">
            <div class="flex-1">
                <h5 class="fw-bold text-dark"><i class="bi bi-calendar-week text-primary"></i>Laporan IT Support</h5>
    ...
    <div class="col-xl-12">
        ...
        <div class="card shadow-sm mb-3">
            <div class="card-header bg-primary text-white">
                <h5 class="card-title mb-0 text-white"><i class="bi bi-filter-square me-2"></i>Filter Laporan IT</h5>
            </div>
            <div class="card-body">
                <form id="formFilter">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            <label for="namaTabel" class="form-label fw-semibold">Pilih Laporan</label>
                            <select class="form-select form-select-lg" id="namaTabel" required>
                                <option value="" selected disabled>-- Pilih Laporan --</option>
                                <option value="kritis">Laporan Kritis</option>
                                <option value="b_harian">Laporan Backup Harian</option>
                                <option value="b_bulanan">Laporan Backup Bulanan</option>
                                <option value="kendala">Laporan Kendala User</option>
                            </select>
                        </div>
...
<script>
    document.getElementById('formFilter').addEventListener('submit', function(event) {
        ...
        $.ajax({
            url: "{{ route('laporan_it_support_get_data') }}",
            type: "POST",
            cache: false,
            data: {
                "_token": "{{ csrf_token() }}",

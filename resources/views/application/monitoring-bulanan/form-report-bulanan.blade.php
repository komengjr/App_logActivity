...
<div class="modal-body p-0">
    <div class="bg-primary rounded-top-lg py-3 ps-4 pe-6">
        <h4 class="mb-1" style="color: white;" id="staticBackdropLabel">Form Report Monitoring Bulanan</h4>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown font-sans-serif">
                        ...
                        <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="email-settings">
                            ...
                            <a class="dropdown-item" href="#!" id="button-preview-backup-bulanan">Preview Backup Bulanan</a>

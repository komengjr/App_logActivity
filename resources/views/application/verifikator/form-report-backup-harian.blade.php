<div class="modal-body p-0">
    <div class="bg-primary rounded-top-lg py-3 ps-4 pe-6">
        <h4 class="mb-1" style="color: white;" id="staticBackdropLabel">Form Report Data Backup Harian</h4>
...
<script>
    ...
    $.ajax({
        url: "{{ route('dashboard_verifikator_cetak_data_backup_harian_report') }}",
        type: "POST",
        cache: false,
        data: {
            "_token": "{{ csrf_token() }}",

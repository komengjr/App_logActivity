...
<div class="card mb-3">
    <div class="card-body border-top">
        <div class="d-flex">
            <div class="flex-1">
                <h5 class="fw-bold text-dark"><i class="bi bi-calendar-week text-primary"></i>Master Data Cabang</h5>
        ...
        <table id="example" class="table table-striped" style="width:100%">
            ...
            <tbody class="fs--1">
                ...
                <tr>
                    ...
                    <td>
                        @php
                        $user = DB::table('users_handler')
                        ->join('tbl_biodata','tbl_biodata.id_user','=','users_handler.id_user')
                        ->where('users_handler.kd_cabang',$datas->kd_cabang)->get();
                        @endphp
                        @foreach ($user as $users)
                        <li>{{ $users->nama_lengkap }} <a href="#" data-bs-toggle="modal" data-bs-target="#modal-cabang"><span class="fas fa-trash-alt text-danger"></span></a></li>
                        @endforeach
                    </td>
                    <td>
                        @php
                        ...
                        ->where('kd_akses',5)
                        ->where('users.cabang',$datas->kd_cabang)->get();
                        @endphp
                        @foreach ($verif as $verifs)
                        <li>{{ $verifs->name }} <a href="#" data-bs-toggle="modal" data-bs-target="#modal-cabang"><span class="fas fa-edit text-warning"></span></a></li>
                        @endforeach
                    </td>
                    <td>
                        @php

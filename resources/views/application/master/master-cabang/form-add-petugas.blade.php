<div class="modal-body p-0">
    ...
    <div class="p-4 pb-3" id="menu-add-data-pr-all">
        <form class="row g-3 pb-3" id="form-add-petugas-cabang" method="POST">
            @csrf
            <input type="text" name="code_cabang" id="code_cabang" value="{{ $code }}" hidden>
            <div class="col-md-12">
                <label for="inputLastName1" class="form-label">Pilih User</label>
                <div class="input-group"> <span class="input-group-text"><i class="fas fa-map-marked-alt"></i></span>
                    <select name="petugas" class="form-control form-control-lg" id="">

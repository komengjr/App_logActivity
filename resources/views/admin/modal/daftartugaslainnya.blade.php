                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if ($item->status_task == 1)
                                    ...
                                    @if (substr($item->tgl_end, 0, 10) < date('Y-m-d'))
                            ...
                            <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                      <a class="dropdown-item" href="javascript:void();" id="buttonuserpengerjaantask" data-id="{{$item->kd_tiket_task}}"><i class="fa fa-eye"></i> Lihat Pengerjaan</a>

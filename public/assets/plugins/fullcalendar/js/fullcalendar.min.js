...
!(function (a) {
    ...
    function r(a) {
        ...
        return (
            s() && "rtl" == a.css("direction") ? (c.left = b) : (c.right = b), c
        );
    }
    function s() {
    ...
    function E(a, b) {
        ...
        for (
            c = 0;
            c < Ra.length && ((d = Ra[c]), (e = F(d, a, b)), !(e >= 1 && W(e)));
            c++
        );
        return d;
    }
    ...
    function Da(c, d) {
        ...
        function i(b) {
            da++,
                ...
                W &&
                    ...
                    (W.displaying &&
                        $.isWithin(W.intervalStart, W.intervalEnd)) ||
        ...
        (Q._fullCalendar_weekCalc = (function (a) {
            ...
            (O.defaultAllDayEventDuration = b.duration(
                P.defaultAllDayEventDuration
            )),
            (O.defaultTimedEventDuration = b.duration(
                P.defaultTimedEventDuration
            )),
            (O.moment = function () {
                var a;
                return (
                    "local" === P.timezone
                        ? ((a = Ja.moment.apply(null, arguments)),
                          a.hasTime() && a.local())
                        : (a =
                              "UTC" === P.timezone
            ...
            (O.getEventEnd = function (a) {
                return a.end
                    ? a.end.clone()
                    : O.getDefaultEventEnd(a.allDay, a.start);
            }),
    ...
    function Ha(c) {
        ...
        function g(b, d) {
            ...
            for (e = 0; e < h.length; e++) {
                if (
                    ((f = h[e].call(M, b, N.clone(), R.clone(), c.timezone, d)),
                    f === !0)
                )
                    return;
        ...
        function q(b) {
            ...
            for (
                ...
                a.isArray(U[d].events) &&
                    (U[d].events = a.grep(U[d].events, b, !0));
            S(X);
        }
        function r(b) {
        ...
        function H(b, c, d, e) {
            ...
            for (h = M.getPeerEvents(e, b), i = 0; i < h.length; i++)
                if (((j = h[i]), L(j, b))) {
                    ...
                    if (e) {
                        if (
                            ((k = Q(j.overlap, (j.source || {}).overlap)),
                            k === !1)
                        )
                            return !1;
    ...
    var $a = ka.extend({
        ...
        bb = (Ja.DragListener = ka.extend({
                ...
                this.isListening ||
                    (b &&
                        ...
                        c.is(window) ||
                            c.is(document) ||
                            ((this.scrollEl = c),
                            (this.scrollHandlerProxy = Y(
                                X(this, "scrollHandler"),
                                100
                            )),
                            this.scrollEl.on(
                                "scroll",
            ...
            startDrag: function (a) {
                this.isListening || this.startListening(),
                    this.isDragging ||
                        ((this.isDragging = !0), this.dragStart(a));
            },
            ...
            dragStop: function (a) {
                ...
                this.trigger("dragStop", a),
                    setTimeout(function () {
                        b.subjectHref &&
                            b.subjectEl.attr("href", b.subjectHref);
                    }, 0);
            },
        ...
        cb = bb.extend({
                    ...
                    a
                        ? ((c = { left: a.pageX, top: a.pageY }),
                          ...
                          e &&
                              ...
                              (this.origCell && (b = w(this.origCell, b) || b),
                              (d = y(b))),
            ...
            scrollStop: function () {
                bb.prototype.scrollStop.apply(this, arguments),
                    this.computeCoords();
            },
            getCell: function (a, b) {
                return (
        ...
        fb = (Ja.Grid = eb.extend({
            ...
            computeRowCoords: function () {
                ...
                for (a = 0; a < this.rowCnt; a++)
                    (b = this.getRowEl(a)),
                        (c = b.offset().top),
                        d.push({ top: c, bottom: c + b.outerHeight() });
                return d;
            },
            computeColCoords: function () {
                ...
                for (a = 0; a < this.colCnt; a++)
                    (b = this.getColEl(a)),
                        (c = b.offset().left),
                        d.push({ left: c, right: c + b.outerWidth() });
                return d;
            },
    ...
    fb.mixin({
            ...
            a.each(
                {
                    ...
                    mousedown: function (d, e) {
                        a(e.target).is(".fc-resizer") &&
                        c.isEventResizable(d.event)
                            ? b.segResizeMousedown(
                                  d,
                                  e,
                                  a(e.target).is(".fc-start-resizer")
                              )
                            : c.isEventDraggable(d.event) &&
                              b.segDragMousedown(d, e);
                    },
                },
                function (c, d) {
        ...
        computeEventResize: function (a, b, c, d) {
            ...
            return (
                ...
                e.allDay &&
                    G(h) &&
                    ((e.allDay = !1), g.normalizeEventRangeTimes(e)),
                e[a].add(h),
                ...
                a.each(d, function (a, b) {
                    b.length &&
                        e.push.apply(
                            e,
                            na(b[0])
                                ? c.eventsToInverseRanges(b)
                                : c.eventsToNormalRanges(b)
                        );
                }),
                e
            );
        ...
        eventsToInverseRanges: function (a) {
            ...
            for (g.sort(qa), b = 0; b < g.length; b++)
                (c = g[b]),
                    c.start > j && h.push({ event: i, start: j, end: c.start }),
                    (j = c.end);
            ...
            (f = this.renderFgSegEls(f)),
                ...
                this.rowEls.each(function (b, f) {
                    ...
                    (g =
                        c && c.row === b
                            ? c.el.position().top
                            : h.find(".fc-content-skeleton tbody").position()
                                  .top),
    ...
    gb.mixin({
        ...
        gb.mixin({
                    ...
                    for (
                        ...
                        if (l) {
                            for (
                                ...
                                (r = a('<td class="fc-more-cell"/>').attr(
                                    "rowspan",
                                    o
                                )),
                                    (k = m[q]),
            ...
            renderSegPopoverContent: function (b, c) {
                ...
                for (
                    c = this.renderFgSegEls(c, !0), this.popoverSegs = c, d = 0;
                    d < c.length;
                    d++
                )
            ...
            getCellSegs: function (a, b) {
                for (
                    var c,
                        d = this.rowStructs[a.row].segMatrix,
                        e = b || 0,
                        f = [];
                    e < d.length;
    ...
    var hb = fb.extend({
        ...
        computeRowCoords: function () {
            var a,
                ...
                d = [];
            for (a = 0; a < this.rowCnt; a++)
                (b = { top: c + this.computeTimeTop(this.computeSnapTime(a)) }),
                    a > 0 && (d[a - 1].bottom = b.top),
                    d.push(b);
            return (
                (b.bottom =
                    b.top + this.computeTimeTop(this.computeSnapTime(a))),
                d
            );
        },
            ...
            return (
                ...
                '<a class="' +
                    ...
                    (c
                        ...
                        : "") +
                    (g.title
                        ? '<div class="fc-title">' + R(g.title) + "</div>"
                        : "") +
                    '</div><div class="fc-bg"/>' +
            ...
            display: function (b) {
                ...
                return (
                    ...
                    this.clear().then(function () {
                        return (c.displaying = a
                            .when(c.displayView(b))
                            .then(function () {
        ...
        jb = (Ja.Calendar = ka.extend({
            ...
            buildViewSpecButtonText: function (a, b) {
                ...
                (a.buttonTextOverride =
                    c(this.overrides) || a.overrides.buttonText),
                    (a.buttonTextDefault =
                        c(this.langDefaults) ||
                        c(this.dirDefaults) ||
    ...
    (jb.defaults = {
        ...
        (jb.englishDefaults = { dayPopoverFormat: "dddd, MMMM D" }),
        (jb.rtlDefaults = {
    ...
    (Ka.basic = { class: qb }),
        (Ka.basicDay = { type: "basic", duration: { days: 1 } }),
        (Ka.basicWeek = { type: "basic", duration: { weeks: 1 } }),
        (Ka.month = {
            class: rb,
            duration: { months: 1 },
    ...
    var sb = ib.extend({
            ...
            updateSize: function (a) {
                this.timeGrid.updateSize(a),
                    ib.prototype.updateSize.call(this, a);
            },
            updateWidth: function () {
    ...
    return (
        ...
        (Ka.agendaDay = { type: "agenda", duration: { days: 1 } }),
        (Ka.agendaWeek = { type: "agenda", duration: { weeks: 1 } }),
        Ja
    );
});
